        ...
        <div class="mx-5 mt-5">
            <form action="/anggota/{{ $anggota->id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" value="{{$anggota->nama}}" type="text" name="nama" id="nama">
                </div>
                <div class="form-group">
                    <label for="alamat">Alamat</label>
                    <input class="form-control" value="{{$anggota->alamat}}" type="text" name="alamat" id="alamat">
                </div>
                <div class="form-group">
                    <label for="no_ktp">No KTP</label>
                    <input class="form-control" value="{{$anggota->no_ktp}}" type="text" name="no_ktp" id="no_ktp">
                </div>
                <div class="form-group">
                    <label for="no_tlp">No Telepon</label>
                    <input class="form-control" value="{{$anggota->no_tlp}}" type="text" name="no_tlp" id="no_tlp">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" value="{{$anggota->tgl_lahir}}" type="date" name="tgl_lahir" id="tgl_lahir">
                </div>
                <div class="form-group">
